...
function ApplySkin(skin, clothes, key, val)
	local playerPed = PlayerPedId()
	...
	if key == 'hair_1' or key == 'hair_2' or key == 'beard_1' or key == 'beard_2' or key == 'beard_3' or key == 'beard_4' or key == 'hair_color_1' or key == 'hair_color_2' or key == 'eyebrows_1' or key == 'eyebrows_2' or key == 'eyebrows_3' or key == 'eyebrows_4' or key == 'makeup_1' or key == 'makeup_2' or key == 'makeup_3' or key == 'makeup_4' or key == 'lipstick_1' or key == 'lipstick_2' or key == 'lipstick_3' or key == 'lipstick_4' then
...
AddEventHandler('skinchanger:change', function(key, val)
	...
	if key == 'sex' then
		...
		ApplySkin(Character, nil, key, val)
	end
end)
